...
const mutations = {
  SET_TOKEN: (state, payload) => {
    ...
    users.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${payload}`;
    store.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${payload}`;
    product.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${payload}`;
  },
